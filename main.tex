...
\documentclass[type=bachelor, output=electronic, fontset=none]{suepthesis}
...
\suepsetup{
  ...
  sub-title = {},
  % 论文标题英文
  title* = {Artificial Intelligence Algorithm Based on Object Detection},
  % 学生姓名
  student = {某同学},
  % 学号
  student-id = {2022****},
